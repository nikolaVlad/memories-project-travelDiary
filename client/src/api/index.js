...
export const fetchPostsBySearch = (searchQuery) =>
  API.get(`/posts/search?searchQuery=${searchQuery.search || 'none'}&tags=${searchQuery.tags}&category=${searchQuery.category}`);
...
export const addFollower = (followerId) => API.patch('/user/follow', { followerId });
